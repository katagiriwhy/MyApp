            ...
            <section className="hero">
                <div className="hero-content">
                    <div className="hero-text">
                        <h1>Индивидуальные занятия для начальных классов</h1>
                        <p>Профессиональный подход к обучению детей с 1 по 4 классы. Развивающие занятия, подготовка к школе, помощь с учебной программой, чистописание.</p>
